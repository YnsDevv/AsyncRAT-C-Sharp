...
namespace SecureByAMn
{
    static class Program
    {
        ...
        static void Main()
        {
            string hw = @"C:\Users\y2ns\Desktop\Hello_World.exe";
            
            string base64enc = Aes256GcmCompression.EncryptBase64(File.ReadAllBytes(hw), "password");
            var bDec = Aes256GcmCompression.Decrypt(base64enc, "password");
            Assembly.Load(bDec).EntryPoint.Invoke(null, new object[] { });
        }
    }
